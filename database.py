...
class Database:
        ...
        async with self.pool.acquire() as conn:
            async with conn.transaction():
                for market in markets:
                    ...
                    VALUES($1,$2,$3::text::time,$4::text::jsonb,$5,$6)
    ...
    async def add_market(
        ...
        async with self.pool.acquire() as conn:
            ...
            VALUES($1,$2,$3::text::time,$4::text::jsonb,4,TRUE)
            RETURNING *
    ...
    async def update_market(
        ...
        *,
        ...
        if open_time is not None:
            fields.append(f"open_time=${index}::text::time")
            values.append(open_time)
            index += 1

        if days is not None:
            fields.append(f"active_days=${index}::text::jsonb")
